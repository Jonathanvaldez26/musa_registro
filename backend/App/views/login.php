                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animation dropdown-lg p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuEcommerce">
                                        ...
                                        <div class="col-12 px-4 py-2">
                                            <div class="row">
                                                <div class="col-12 position-relative">
                                                    ...
                                                    <input class="chk-datos" id="chk-0" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-0"><i class="fas fa-language"> </i> Idioma</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-0"><i class="fas fa-fan"> </i> Español</label>
                                                        

                                                    <input class="chk-datos" id="chk-1" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-1"><i class="fas fa-money-bill"> </i> Moneda</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-1"><i class="fas fa-fan"> </i> Peso mexicano</label>

                                                    <input class="chk-datos" id="chk-2" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-2"><i class="fas fa-utensils"> </i> Gastronomía</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-2"><i class="fas fa-fan"> </i> 
                                                            La Cocina Mexicana es conocida por su suculencia y su gran <br>
                                                            variedad. <br><br>
                                                            Sus orígenes se remontan al período prehispánico, cuando una <br>
                                                            gran cantidad de platillos giraban alrededor del maíz, junto con <br>
                                                            otros ingredientes como: chiles, frijoles, calabazas, guacate, <br>
                                                            tomate, cacao, nopal, así como insectos y una gran variedad de <br>
                                                            frutas.
                                                    </label>

                                                    <input class="chk-datos" id="chk-3" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-3"><i class="fas fa-plane"> </i> Distancia entre Aeropuerto y sede</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-3"><i class="fas fa-fan"> </i> 1 hora 5min. </label>

                                                    <input class="chk-datos" id="chk-4" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-4"><i class="fas fa-clock"> </i> Huso horario</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-4"><i class="fas fa-fan"> </i> UTC-05:00</label>

                                                    <input class="chk-datos" id="chk-5" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-5"><i class="fas fa-sun"> </i> Clima</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-5"><i class="fas fa-fan"> </i> 
                                                            El tiempo en Cancún durante abril 2022 será caluroso. La <br>
                                                            temperatura más baja que podrán encontrar será de 25°C y <br>
                                                            temperaturas altas de 29°C grados, es importantísimo tomar <br>
                                                            mucha agua y mantenerte fresco.<br><br>
                                                            Habrá días de lluvia durante el mes de Abril en Cancún, así <br>
                                                            que recomendamos traer una chaqueta a prueba de agua para <br>
                                                            mantenerse seco este mes.

                                                    </label>

                                                    <input class="chk-datos" id="chk-6" type="checkbox">
                                                    <label class="dropdown-item border-radius-md" for="chk-6"><i class="fas fa-tshirt"> </i> Vestimenta Recomendada</label>
                                                    <label class="dropdown-item border-radius-md mx-2" id="lbl-6"><i class="fas fa-male"> </i> 
                                                            Hombres: <br><br>
                                                            Las telas más recomendables para estos eventos son: lino, <br>
                                                            algodón delgado y seda. Recuerda que los colores claros te <br>
                                                            ayudaran a sentirte más fresco y que dependiendo de la hora <br>
                                                            del día puede hacer más o menos calor, por lo que debes estar <br>
                                                            preparado.
                                                                <br><br>
                                                            <i class="fas fa-female"> </i>
                                                            Mujeres: <br><br>
                                                            Las telas mas recomendables para estos eventos son:  sedas, <br>
                                                            linos, chiffon o chalis. Puedes usar traje tipo sastre, de <br>
                                                            telas frescas y puedes apostar por colores y estampados <br>
                                                            sutiles, o un vestido de corte ¾ o debajo de la rodilla.
                                    ...
                                    <div class="d-lg-none">
                                        ...
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-language"> </i> Idioma</span>
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-money-bill"> </i> Moneda</span>
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-utensils"> </i> Gastronomía</span>
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-plane"> </i> Distancia entre Aeropuerto y sede</span>
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-clock"> </i> Huso horario</span>
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-sun"> </i> Clima</span>
                                        <span class="dropdown-item border-radius-md"><i class="fas fa-tshirt"> </i> Vestimenta Recomendada</span>
